...
function(t, i) {
    ...
    function u() {
        ...
        e ? r.href = e.href : (t.removeEventListener("scroll", f), t.removeEventListener("resize", v)), c = i.documentElement.scrollHeight, a = s = !1
    }
    ...
    function e() {
        if (!a)
            if (d + l <= c - o) s = !1;
                ...
                e.responseType = "document", e.addEventListener("load", u), e.open("GET", r.href), e.send(null)
            }
    }
